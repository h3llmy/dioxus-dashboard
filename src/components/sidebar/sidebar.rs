                ...
                ul { class: "space-y-2 font-medium",
                    ...
                    li {
                        a {
                            ...
                            href: "#",
                            icons::icon_2 {}
                            span { class: "flex-1 ms-3 whitespace-nowrap", "Kanban" }
                    ...
                    li {
                        a {
                            ...
                            href: "#",
                            icons::icon_3 {}
                            span { class: "flex-1 ms-3 whitespace-nowrap", "Inbox" }
                    ...
                    li {
                        a {
                            ...
                            href: "#",
                            icons::icon_4 {}
                            span { class: "flex-1 ms-3 whitespace-nowrap", "Users" }
                        }
                    }
                    li {
                        a {
                            ...
                            href: "#",
                            icons::icon_5 {}
                            span { class: "flex-1 ms-3 whitespace-nowrap", "Products" }
                        }
                    }
                    li {
                        a {
                            ...
                            href: "#",
                            icons::icon_6 {}
                            span { class: "flex-1 ms-3 whitespace-nowrap", "Sign In" }
                        }
                    }
                    li {
                        a {
